        ...
        return (
            ...
            >
                <a
                    ...
                    rel={'noreferrer'}
                >
                    <div className="image aspect-video block bg-origin-padding bg-left-top bg-cover bg-no-repeat z-0 relative"
                        ...
                        <div className={'overlay'}>
                            <div className={'text'}>
                                ...
                                <div className={'flex flex-row items-center play-button'}>
